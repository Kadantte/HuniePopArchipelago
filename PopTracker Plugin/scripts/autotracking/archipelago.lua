...
function apply_slot_data(slot_data)
    ...
    for k,v in pairs(slot_data["girldata"]) do
...
function resetloc(girl, slot, id)
	local obj = Tracker:FindObjectForCode("@"..girl.." Gift "..(slot:sub(5)).."/Gift "..girl.." "..GIFT_MAPPING[id])
...
function getgiftlocation(giftmap)
    ...
    --  "@tiffany Gift 1/Gift tiffany Decorative Pens"
    if Tracker:ProviderCountForCode(test[1]..' gift1') == tonumber(test[2]) then
        return "@"..test[1].." Gift 1/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift2') == tonumber(test[2]) then
        return "@"..test[1].." Gift 2/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift3') == tonumber(test[2]) then
        return "@"..test[1].." Gift 3/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift4') == tonumber(test[2]) then
        return "@"..test[1].." Gift 4/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift5') == tonumber(test[2]) then
        return "@"..test[1].." Gift 5/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift6') == tonumber(test[2]) then
        return "@"..test[1].." Gift 6/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift7') == tonumber(test[2]) then
        return "@"..test[1].." Gift 7/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift8') == tonumber(test[2]) then
        return "@"..test[1].." Gift 8/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift9') == tonumber(test[2]) then
        return "@"..test[1].." Gift 9/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift10') == tonumber(test[2]) then
        return "@"..test[1].." Gift 10/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift11') == tonumber(test[2]) then
        return "@"..test[1].." Gift 11/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift12') == tonumber(test[2]) then
        return "@"..test[1].." Gift 12/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift13') == tonumber(test[2]) then
        return "@"..test[1].." Gift 13/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift14') == tonumber(test[2]) then
        return "@"..test[1].." Gift 14/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift15') == tonumber(test[2]) then
        return "@"..test[1].." Gift 15/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift16') == tonumber(test[2]) then
        return "@"..test[1].." Gift 16/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift17') == tonumber(test[2]) then
        return "@"..test[1].." Gift 17/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift18') == tonumber(test[2]) then
        return "@"..test[1].." Gift 18/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift19') == tonumber(test[2]) then
        return "@"..test[1].." Gift 19/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift20') == tonumber(test[2]) then
        return "@"..test[1].." Gift 20/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift21') == tonumber(test[2]) then
        return "@"..test[1].." Gift 21/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift22') == tonumber(test[2]) then
        return "@"..test[1].." Gift 22/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift23') == tonumber(test[2]) then
        return "@"..test[1].." Gift 23/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    elseif  Tracker:ProviderCountForCode(test[1]..' gift24') == tonumber(test[2]) then
        return "@"..test[1].." Gift 24/Gift "..test[1].." "..GIFT_MAPPING[tonumber(test[2])]
    end
